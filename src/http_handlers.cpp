...
HandlerResponse ProfilerHttpHandlers::handleHeapAnalyze(int duration, const std::string& output_type) {
    duration = clampDuration(duration, 1, 300);
    ...
    std::string svg = profiler_.analyzeHeapProfile(duration, output_type);
